...
// Updated schema for new password setup
...
export default function LoginPage() {
  ...
  // Updated handler for setting new password
  ...
  // Updated render new password setup form
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                {newPasswordErrors.email && (
                  <p className="text-sm text-red-500">{newPasswordErrors.email.message}</p>
                )}
              </div>
              <div className="space-y-2">
